...
km = int (input("você andou quantos km com o carro"))
if modelo == "Audi":
    diaria = 105
elif modelo == "Mustang":
    diaria = 200
    ...
    diaria = 89
print(f"você deverá pagar R${diaria * dias} por dias alugados e R${km * 0.15} o total a ser pago é R${diaria * dias + km * 0.15} ")